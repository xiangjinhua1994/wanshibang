<template>
  <view class="goods-item" @click="jumpPage(pargoodsList.productId)">
    ...
    <!-- <image width="104rpx" v-if="pargoodsList.activityProduct==1" height="104rpx" style="width:204rpx;height:58rpx;position:absolute;left:0rpx;bottom:38rpx;" threshold="10" src="../../static/bgActivity3.png"  mode=""/> -->
...
.goods-item {
  ...
  display: flex;
  justify-content: space-between;
  //border-bottom: 1rpx #f00 solid;
  //width: 750rpx;
  box-sizing: border-box;
  margin: 32rpx 28rpx 32rpx 28rpx;

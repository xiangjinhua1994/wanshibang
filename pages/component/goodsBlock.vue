<template>
  <view class="goods-item2" @click="jumpPage(parentitem.productId)">
      ...
      <view class="radio d-s-c radio-ui" v-show="showRadio">
        ...
        <view class="goods-img-box" style="position:relative">
          <ImageLazyLoad width="344rpx" height="344rpx"  class="goods-img" threshold="100" :image="parentitem.productImage"/>
          <!-- <image width="104rpx" v-if="parentitem.activityProduct==1" height="104rpx" style="width:100%;height:88rpx;position:absolute;left:0rpx;bottom:-8rpx;opacity:1;" threshold="10" src="../../static/bgActivity3.png"  mode=""/> -->
        </view>
    <view class="goods-detail" :style="{'background-color': bg}">
      <view class="goods-title" >
        <scroll-view scroll-y="true">
          <image class="goods-national" :src="parentitem.countryImage" mode="" v-lazy />

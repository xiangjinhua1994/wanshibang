<template>
  <view class="bg-lottery pr"
    ...
    <view class="lottery-title">
      <almost-lottery :prizeList="prizeList"
    ...
    <view class="ww100 mb23 mt40">
      <button type="primary"
              class="record"
              @click="gotoPage('/pages/plus/lottery/WinningRecord')">
        中奖记录
    ...
    <popup :show="isRule"
           ...
           :height="550"
           :padding="0"
           @hidePopup="isRule = false"
           backgroundColor="none">
      <view class="pop-center">
        <image class="bg-rule"
               src="/static/invite/bg-rule.png"
               mode=""></image>

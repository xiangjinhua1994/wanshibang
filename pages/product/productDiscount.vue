<template>
  ...
  export default {
    ...
    methods: {
      ...
      self._get(
        'index/homePage',
        { type: 'specialOfferZone' ,key:'titleName',appVersion: this.version_number},
        function (res) {
          if (res.code === 1) {
      ...
      getclassgoodslist(isLoadMore = false) { //获取商品
        ...
        self._postBody(
          ...
          { pageIndex: nextPageIndex, pageSize: 20, type:'specialOfferZone',appVersion: this.version_number,categoryId: self.categoryId,productIdList:productIdList},
          function (res) {
            // console.log("获取商品列表====")
            // console.log(res)

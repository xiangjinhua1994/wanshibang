<template>
	...
	<view>
		...
		<view class="d-c-c position-absolute " :style="'width: 750rpx;height:'+windowHeight+'px;'">
			<view class="d-c bg-white box-shadow rounded-3" style="width: 604rpx;height: 868rpx;">
				<view class="d-c-c" style="height: 100rpx;">
					<text class="fb f32">服务协议和隐私政策</text>
				</view>
				<view class="flex-1 my-2 f26 liln-h-40" style="padding:36rpx;">
				...
				<view class="" style="margin-top:60rpx;padding:0 36rpx;">
					<view style="background:#000;border-radius:90rpx;height: 80rpx;" class="d-c-c flex-1  main-bg" @click="submit"><text class="text-white f28">同意并接受</text></view>
					<view style="background:#fff;border-radius:90rpx;height: 80rpx;border: 2rpx solid #000000;margin-top:34rpx;" class="d-c-c flex-1" @click="quit"><text class=" text-black f28">暂不同意</text></view>
				</view>
			</view>
		</view>
	</view>
